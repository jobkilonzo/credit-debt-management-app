...
public class CreditorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Credits");
    ...
    private void customDialog() {
        ...
        AlertDialog.Builder myDialog = new AlertDialog.Builder(CreditorsActivity.this);
        View view = LayoutInflater.from(CreditorsActivity.this).inflate(R.layout.input_data, null);
    ...
    public void fetch(){
        ...
        FirebaseRecyclerOptions<Data> options =
                new FirebaseRecyclerOptions.Builder<Data>()
                        ...
                        .build();
        adapter = new FirebaseRecyclerAdapter<Data, HomeActivity.MyViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull HomeActivity.MyViewHolder holder, final int position, @NonNull final Data model) {
            ...
            @NonNull
            @Override
            public HomeActivity.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    public void updateData(){
        AlertDialog.Builder myDialog = new AlertDialog.Builder(CreditorsActivity.this);
        View view = LayoutInflater.from(CreditorsActivity.this).inflate(R.layout.update_data, null);
        ...
        TextView head = view.findViewById(R.id.update_head);
        head.setText("Update credit");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.debts:
                startActivity(new Intent(CreditorsActivity.this, HomeActivity.class));
                break;
            case R.id.credit:
                startActivity(new Intent(CreditorsActivity.this, CreditorsActivity.class));
                break;
            case R.id.details:
                startActivity(new Intent(CreditorsActivity.this, DetailsActivity.class));
                break;
            case R.id.logout:
                mAuth.signOut();
                startActivity(new Intent(CreditorsActivity.this, MainActivity.class));
                break;
        }
